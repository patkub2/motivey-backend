...
public enum AbilityType {
    ...
    NIMBLE_MIND,         //NIMBLE_MIND Increases effectiveness of AGI-based tasks (exp base)
    ...
    ///////////// INT
    MIND_SURGE,          //MIND_SURGE gain MP
    ARCANE_INSIGHT,      //ARCANE_INSIGHT Enhances mana regeneration
    WISDOM_WAVE,         //WISDOM_WAVE Increases effectiveness of INT-based tasks (exp base)
    ...
    IRON_RESOLVE,        //IRON_RESOLVE Enhances HP regeneration
    BRUTE_FORCE,         // Temporarily boosts STR stats during challenges
    TITAN_S_GRIP,          //TITAN_S_GRIP Increases effectiveness of STR-based tasks (exp base)
    POWER_SURGE,          // Reduces effort needed for STR-related tasks

    ///////////// VIT
    STEADFAST,           //STEADFAST Gain HP
    ENDURING_SOUL,       // Enhances HP regeneration rate
    RESILIENT_SPIRIT,    // Reduces damage taken during VIT challenges
    LIFE_S_BOUNTY,       //LIFE_S_BOUNTY Increases effectiveness of VIT-based tasks (exp base)
